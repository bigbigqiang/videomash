class Draggable {
    ...
    onTouchEnd(e) {
        ...
        document.removeEventListener('touchmove', this.onTouchMoveCopy)
        document.removeEventListener('touchend', this.onTouchEndCopy)
    }
    ...
    onTouchStart(ev, el, binding, vNode) {
        this.T = setTimeout(() => {
            ...
            this.onTouchMoveCopy = this.onTouchMove.bind(this)
            this.onTouchEndCopy = this.onTouchEnd.bind(this)
            document.addEventListener('touchmove', this.onTouchMoveCopy, { passive: false })
            document.addEventListener('touchend', this.onTouchEndCopy)
        }, 300)
    }
